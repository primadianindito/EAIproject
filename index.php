  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <?php
          ...
          switch ($image_weather) {
              case "Cloudy":
                  echo "<img src='images/cuaca/con_cloudy.png' style='width:40px;height:40px;'>";
                  break;
              case "Partly Cloudy":
                  echo "<img src='images/cuaca/con_partlycloudy.png' style='width:40px;height:40px;'>";
                  break;
              case "Sunny":
                  echo "<img src='images/cuaca/con_sunny.png' style='width:40px;height:40px;'>";
                  break;
              case "Mostly Sunny":
                  echo "<img src='images/cuaca/con_mostlysunny.png' style='width:40px;height:40px;'>";
                  break;
              case "Scattered":
                  echo "<img src='images/cuaca/con_scatteredthunderstorm.png' style='width:40px;height:40px;'>";
                  break;
              case "Thunderstorms":
                  echo "<img src='images/cuaca/con_thunderstorm.png' style='width:40px;height:40px;'>";
                  break;
              case "Showers":
                  echo "<img src='images/cuaca/con_rain.png' style='width:40px;height:40px;'>";
                  break;
              case "Rain":
                  echo "<img src='images/cuaca/con_rain.png' style='width:40px;height:40px;'>";
                  break;
              case "Windy":
                  echo "<img src='images/cuaca/con_windy.png' style='width:40px;height:40px;'>";
                  break;
              case "Mostly Cloudy":
                  echo "<img src='.images/cuaca/con_cloudy.png' style='width:40px;height:40px;'>";
                  break;
              ...
              case "Scattered Showers":
                  echo "<img src='images/cuaca/con_scatteredrain.png' style='width:40px;height:40px;'>";
                  break;    
              default:
                  echo "-";
          }
